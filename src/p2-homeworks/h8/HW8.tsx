...
export type UserType = Array<singleUserType>
...
function HW8() {
    ...
    return (
        <div>
            ...
            <div style={{display:'inline-block'}}><SuperButton onClick={checkAge}>check 18</SuperButton></div>
